...
class _WaitingRoomState extends State<WaitingRoom> {
  final TextEditingController _programPasswordController =
  ...
  checkForAuth() async {
    ...
    if (userInfo != null && userId != null) {
      ...
      if (userInfo[1] == 'player' &&
          ...
          relatedUser.currentStage <= allRelatedStage.length - 1) {
  ...
  handleEnterGame() async {
    ...
    final allRelatedProgram =
        Program.fromJson(snapshot.data() as Map<String, dynamic>);

    if (_programPasswordController.text.toString() ==
        allRelatedProgram.password) {
      ...
      if (relatedUser.startAt.isEmpty) {
        usersCollection
            ...
            .update({'startAt': timeStart.toIso8601String()});
      }
                    ...
                    InkWell(
                      ...
                      child: Container(
                          ...
                          child: Row(
                            children: [
                              Image.network(
                                  'https://res.cloudinary.com/dhrpdnd8m/image/upload/v1649671485/right-arrow_qulvq4.png',
                                  width: 30),
                              const SizedBox(width: 10),
                              const Text('Start to play',
                                  style: TextStyle(
                                      color: Colors.white,
                                      fontSize: 18,
                                      fontWeight: FontWeight.w700))
                      ...
                      onTap: !isAuthDevice
                          ...
                          : () {
                              ...
                              Navigator.of(context)
                                  .pushReplacementNamed('/update-info');
                            },
                      child: Container(
                          padding: const EdgeInsets.symmetric(
                              horizontal: 15, vertical: 10),
                          ...
                          child: Row(
                            children: [
                              Image.network(
                                  'https://res.cloudinary.com/dhrpdnd8m/image/upload/v1649670849/exam_mzkm0b.png',
                                  width: 30),
                              const SizedBox(width: 10),
                    ...
                    InkWell(
                      ...
                      child: Container(
                          ...
                          child: Row(
                            children: [
                              Image.network(
                                  'https://res.cloudinary.com/dhrpdnd8m/image/upload/v1659322178/l2znkw8hqeggwph8ah71.png',
                                  width: 30),
                              const SizedBox(width: 10),
                              const Text('Log out my account',
                                  style: TextStyle(
                                      color: Colors.white,
                                      fontSize: 18,
                                      fontWeight: FontWeight.w700))
